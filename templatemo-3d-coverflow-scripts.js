...
// JavaScript Document
        ...
        const imageData = [
            {
                title: "Americano",
                description: "A cafe known for serving bold and smooth black coffee"
            },
            {
                title: "Latte",
                description: "A cozy cafe offering creamy and milky coffee drinks, ideal for customers who love light"
            },
            {
                title: "Mocha",
                description: "A sweet and rich cafe featuring chocolate infused coffee blends"
            },
            {
                title: "Frappe",
                description: "A refreshing cafe specializing in iced blended drinks"
            },
            {
                title: "Cappuccino",
                description: "A cafe with a classic and blanded stytle"
            },
            {
                title: "Macchiato",
                description: "A cafe offering bold espresso with a touch of milk"
            },
            {
                title: "Expresso",
                description: "A speciality cafe focudes on concentrated and intense coffee shots"
            }
        ];
